...
from zeroband.training.orchestrator.genesys.deepcoder_utils.utils import BASE_IMPORTS
...
"""
    ...
    with TemporaryDirectory() as tmpdir:
        ...
        try:
            ...
            return (
                False,
                _ERROR_MSG_PREFIX + f"Execution timed out after {timeout} seconds.",
            )
        except Exception as e:
            return (
                False,
                _ERROR_MSG_PREFIX + f"An Exception occurred in the code: {str(e)}",
            )
